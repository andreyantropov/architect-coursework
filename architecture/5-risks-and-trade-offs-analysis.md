...
| Риск                              | Описание                                         | Снижение                                                     |
| --------------------------------- | ------------------------------------------------ | ------------------------------------------------------------ |
| Производительность в React Native | Может быть ниже, чем у нативных приложений       | Минимизация нативных зависимостей, оптимизация, tree shaking |
...
## 1. Сценарий: Пользователь завершает тренировку
...
## 2. Сценарий: Отправка push-уведомления
...
## 3. Сценарий: A/B тестирование маркетинговой акции
